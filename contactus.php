	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2><b> UNIVERSAL HOSPITAL </b><h2>
					<h5>The Area’s Most Experienced Hospital.
					    <br>The Highest Quality Healthcare.
						<br>The hospital you trust to care for those you love.
					</h5>
					
							<h4>Near Bhajansons & Punyadham Kaman, Bhiwandi Rd, Vasai-Virar, Maharashtra 401208.</h4>
							
						<h4> <br>
							Contact us:  +918007000755</h4><br>
				</article>
			</div>
			<div class="col-md-6">
